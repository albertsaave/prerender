...
server.onResourceRequestedCallback = function (req, res, request) {
    console.log("onResourceRequestedCallback: testing against request.url" + request.url);
...
server.checkIfPageIsDoneLoading = function(req, res, force) {
    ...
    console.log("checkIfPageIsDoneLoading: timedOut=" + timedOut + " url: " + req.prerender.url);
...
server.javascriptToExecuteOnPage = function() {
    try {
        ...
        if (html && html[0]) {
          console.log( "phantomdId:" + req.prerender.phantomId + " " + 'javascriptToExecuteonPage: html NOT empty');
        ...
        console.log( "phantomdId:" + req.prerender.phantomId + " " + 'javascriptToExecuteOnPage: Exception:');
        console.log(e);
    }

    console.log( "phantomdId:" + req.prerender.phantomId + " " +'javascriptToExecuteOnPage: html IS empty');
